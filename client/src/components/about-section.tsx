...
export default function AboutSection() {
  return (
    <section id="about" className="py-20" style={{backgroundColor: '#1E293B'}} data-testid="about-section">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="text-3xl md:text-4xl font-bold text-blue-300 uppercase">
              ABOUT ADINSPIRE
            </h3>
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div className="text-center p-6 bg-slate-800 rounded-lg shadow-lg border border-slate-700">
                <div className="text-3xl font-bold text-blue-300 mb-2" data-testid="projects-stat">150+</div>
                <div className="text-slate-300 uppercase font-semibold">
                  Projects Completed
                </div>
              </div>
              <div className="text-center p-6 bg-slate-800 rounded-lg shadow-lg border border-slate-700">
                <div className="text-3xl font-bold text-amber-400 mb-2" data-testid="satisfaction-stat">98%</div>
                <div className="text-slate-300 uppercase font-semibold">
                  Client Satisfaction
                </div>
              </div>
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-amber-400/20 to-transparent rounded-2xl"></div>
          </motion.div>
        </div>
      </div>
    </section>
