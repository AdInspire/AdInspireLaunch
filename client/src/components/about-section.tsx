        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div className="text-center p-6 bg-gray-700 rounded-lg shadow-lg border border-gray-600">
              ...
              <div className="text-center p-6 bg-gray-700 rounded-lg shadow-lg border border-gray-600">
                <div className="text-3xl font-bold text-yellow-500 mb-2" data-testid="satisfaction-stat">98%</div>
                <div className="text-gray-300 uppercase font-semibold">
                  Client Satisfaction
                </div>
              </div>
