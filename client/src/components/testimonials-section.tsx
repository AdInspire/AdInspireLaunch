...
export default function TestimonialsSection() {
  ...
  return (
    <section 
      id="testimonials" 
      className="py-20" style={{backgroundColor: '#1E293B'}}
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {testimonials.slice(0, 3).map((testimonial, index) => (
            <motion.div
              key={index}
              className="bg-slate-800/90 backdrop-blur-sm p-8 rounded-2xl border border-slate-600 cursor-pointer group transition-all duration-400 hover:transform hover:-translate-y-2 hover:scale-105 hover:shadow-2xl hover:border-amber-400/50"
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h4 className="text-slate-100 font-bold text-lg">{testimonial.name}</h4>
