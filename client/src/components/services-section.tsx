    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-2 bg-gradient-to-r from-orange-500 to-purple-600 mx-auto rounded-full mt-6"></div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              key={index}
              className={`bg-slate-700/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-600 ${service.hoverColor} transition-all duration-300 group`}
